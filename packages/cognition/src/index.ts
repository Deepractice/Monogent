...
export type { Categorization } from './interfaces/stages/Categorization.js'
export type { Abstraction } from './interfaces/stages/Abstraction.js'
...
export { categorization } from './interfaces/stages/Categorization.js'
export { abstraction } from './interfaces/stages/Abstraction.js'
